    ...
    return (
            ...
            <div className="max-w-sm w-4/6 md:w-full lg:max-w-full lg:flex mx-2 md:mx-4">
                ...
                <img src={logo} />
                    ...
                    <div className="text-gray-900 font-bold text-xs md:text-sm lg:text-lg mb-1 md:mb-2">Can coffee make you a better developer?</div>
                     </div>
                    <div className="flex items-center">
                   
                    <div className="text-xs lg:text-sm text-start">
                        <div className="text-gray-900 leading-none">{p.user}</div>
                        <div className="hidden lg:block text-xs text-gray-600">{p.date.toString()}</div>
                    </div>
                    </div>
                </div>
            </div>
