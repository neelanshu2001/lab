...
const Card:FC<{name:string,description:string}>=({name,description})=> {
   // console.log(name);
    return (
        <div className='hover:cursor-pointer hover:opacity-95 hover:text-blue-400 w-28 md:w-40 lg:w-52 xl:w-60'>
        ...
        <div className="px-2 md:px-6 pt-2 md:pt-4">
            ...
            <div className="hidden md:block   text-xs md:text-sm text-start font-serif  px-3 py-1 bg-gray-100 rounded-lg  md:max-h-screen">
            {description}
            </div>
